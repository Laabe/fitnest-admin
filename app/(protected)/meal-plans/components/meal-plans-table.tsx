...
export default function MealPlansTable({ mealPlans, onView, onEdit, onDelete }: MealPlansTableProps) {
    ...
    return <DataTable columns={columns} data={mealPlans} emptyMessage="No meals available" />;
}
